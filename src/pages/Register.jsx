  ...
  return (
    <div class="w-full max-w-lg mt-16 mx-auto">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <h1 className='text-2xl font-bold text-indigo-600 my-5'>Register Form</h1>
            <div class="mb-4">
            ...
            <button class="bg-indigo-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                Register
            </button>
